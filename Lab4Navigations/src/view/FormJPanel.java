...
public class FormJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        photoSelectedLabel = new javax.swing.JTextField();
        ...
        photoSelectedLabel.setEditable(false);
        photoSelectedLabel.setBackground(new java.awt.Color(63, 58, 118));
        photoSelectedLabel.setFont(new java.awt.Font("Cantarell", 0, 18)); // NOI18N
        photoSelectedLabel.setForeground(new java.awt.Color(255, 255, 255));
        photoSelectedLabel.setToolTipText("Please enter your email");
        photoSelectedLabel.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(63, 58, 118), 5));
        photoSelectedLabel.setCaretColor(new java.awt.Color(255, 255, 255));
        photoSelectedLabel.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        photoSelectedLabel.setSelectedTextColor(new java.awt.Color(0, 0, 0));
        photoSelectedLabel.setSelectionColor(new java.awt.Color(63, 58, 118));
        photoSelectedLabel.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                photoSelectedLabelActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(genderComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 334, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(dateOfBirthLabel)
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(photoSelectedLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 336, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(18, 18, 18)
                                        .addComponent(photoChooserButton, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addComponent(dateOfBirthDateChooser, javax.swing.GroupLayout.PREFERRED_SIZE, 336, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(photoSelectedLabel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        try {
            ...
            userObject.setProfilePhoto(profilePicture);
            ...
            if (userObject.getProfilePhoto() == null){
                JOptionPane.showMessageDialog(this, "Please upload an image.", "Error - No image", JOptionPane.ERROR_MESSAGE);
                return;
            }

            JOptionPane.showMessageDialog(this, userObject.toString(), "Account created!", HEIGHT, userObject.getProfilePhoto());
    ...
    private void photoChooserButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_photoChooserButtonActionPerformed
        ...
        if (file.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
            ...
            if (edited_image != null) {
                ...
                this.submittedPhoto.setIcon(icon);
            }
            } catch (Exception ex) {
    ...
    private void photoSelectedLabelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_photoSelectedLabelActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_photoSelectedLabelActionPerformed
    ...
    private javax.swing.JTextField photoSelectedLabel;
